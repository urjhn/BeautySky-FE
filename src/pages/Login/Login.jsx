...
//     try {
//       setLoading(true);
//       window.open("https://localhost:7112/api/Google/google-login", "_self");
//     } catch (error) {
...
//             <h3 className="text-2xl font-semibold text-center mb-4">Đăng nhập</h3>
...
//                 type="submit"
//                 disabled={loading}
//                 className={`w-full py-2 rounded-lg transition duration-300 ${loading ? "bg-gray-400" : "bg-[#6bbcfe] hover:bg-blue-600 text-white"}`}
//               >
...
//             </button>
//             <p className="text-center text-gray-500 text-xs mt-4">Terms & Conditions of FASCO</p>
//           </div>
//         </div>
//       </div>
//       <Footer />
